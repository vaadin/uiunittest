...
public class MockServletRequest implements HttpServletRequest {
	...
	public String getHeader(String name) {
		return headers.get(name) != null && headers.get(name).size() == 1 ? headers.get(name).get(0) : null;
	}

	@Override
	public Enumeration<String> getHeaders(String name) {
		return headers.get(name) != null ? Collections.enumeration(headers.get(name)) : null;
	}
